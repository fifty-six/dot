...
// i love my ide it works so well
#ifndef LAYOUT_plaid_grid
...
[_QWERTY] = LAYOUT_plaid_grid(
    ...
    KC_LCTL, KC_RALT, KC_LALT, KC_RGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT
),
...
[_LOWER] = LAYOUT_plaid_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______    , SOCD
),
...
[_RAISE] = LAYOUT_plaid_grid(
    ...
    KC_PSCR, KC_HOME, _______, KC_INSERT, _______, _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______  , TO(_NPAD),
...
[_ADJUST] = LAYOUT_plaid_grid(
    QK_BOOT, LED_1  , LED_2  ,  LED_3  , LED_4  , LED_5  ,LED_6   , LED_7  , LED_8  , LED_9  , LED_0  , TO(_NPAD) ,
    _______, KC_PWR , KC_SLEP,  KC_WAKE, KC_EJCT, _______, _______, _______, _______, _______, _______, _______ , // TO(_VJOY) ,
    _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______ ,
    _______, _______, _______,  _______, _______, SOCD   , SOCD   , _______, _______, _______, _______, _______
),

[_NPAD] = LAYOUT_plaid_grid(
    KC_PAST,     _______, _______,  _______, _______, _______,   KC_INSERT, KC_DEL , KC_HOME, KC_END , _______, KC_0   ,
    _______,     KC_KP_4, KC_KP_2,  KC_KP_6, _______, _______,   KC_PGUP  , KC_PGDN, KC_PSLS, _______, _______, KC_HOME,
    _______,     _______, _______,  _______, _______, _______,   _______  , _______, _______, _______, _______, KC_KP_0,
    TO(_QWERTY), _______, _______,  _______, _______, KC_KP_8,   KC_KP_8  , _______, _______, _______, _______, _______
),

// [_VJOY] = LAYOUT_plaid_grid(
//     JSB(0),     _______, _______,  _______, _______, _______,   JSB(4), JSB(5) , JS_BUTTON6, JSB(7) , _______, KC_0   ,
//     _______,     JSB(1), JSB(2),  JSB(3), _______, _______,   JSB(8)  , JSB(9), JSB(10), _______, _______, _______,
//     _______,     _______, _______,  _______, _______, _______,   _______  , _______, _______, _______, _______, JSB(13),
//     TO(_QWERTY), _______, _______,  _______, _______, JSB(11),   JSB(11)  , _______, _______, _______, _______, _______
// )
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    if (keycode == SOCD && record->event.pressed) {
        socd = !socd;
        return false;
    }
    ...
    switch (keycode) {
        case KC_SPC: {
            if (record->event.pressed) {
                // If right was already pressed, undo it so we overwrite it
                if (dirs & Down) {
                ...
                // If we had L+R pressed and we release L, put back R *if* it's older
                if (dirs & Down && oldest & Down) {
                    register_code(KC_S);
                }

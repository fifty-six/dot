...
[_RAISE] = LAYOUT_plaid_grid(
    ...
    KC_PSCR, KC_HOME, _______, KC_INSERT, _______, _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______  , _______,
...
[_NPAD] = LAYOUT_plaid_grid(
    ...
    _______,     KC_KP_4, KC_KP_2,  KC_KP_6, _______, _______,   KC_PGUP  , KC_PGDN, KC_PSLS, _______, _______, _______,
